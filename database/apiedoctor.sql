...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2019 at 12:04 PM
...
(6, 'thienthanh@gmail.com', 'asd1z3123!I', 1, 1, 'bacsi.jpg', 'Nguyễn Thiện Thanh', '5', '5', '22', 'Bác sĩ chuyên khoa lồng ngực', 'Đại học y dược', 'Chứng chỉ về bác sĩ chuyên khoa', 0, 0, 0, '0392300000', '1975-06-07', 1),
...
(19, 49, 3, '2019-07-18', 120000, 7, '5skjqajrrq08f603izwjzv', 1, 0, 1),
(20, 49, 3, '2019-07-18', 0, 7, 'ky2rqouni3rykky3pnma', 1, 6, 1),
(21, 49, 5, '2019-07-18', 0, 6, '0ak7j3tcvmqanumhj9p809k', 1, 7, 2),
(22, 64, 3, '2019-07-18', 120000, 7, '230lsacxccq9t7vpe7sus', 1, 0, 2),
(23, 64, 3, '2019-07-18', 120000, 7, 'kmwcezkplj6th7ppzj3oe', 1, 0, 1),
(24, 64, 3, '2019-07-19', 0, 9, 'mqa27knbb8kgbei4kw7hym', 1, 6, 1),
(25, 64, 3, '2019-07-19', 0, 9, 'f1ri3ubah8ke8ujvivl3ya', 1, 6, 1),
(26, 64, 3, '2019-07-19', 0, 9, 'qwahgy1934mg9vdw6mzzk', 1, 6, 2),
(27, 64, 3, '2019-07-19', 0, 9, '03676u4rx0man1cqjqrehq', 1, 6, 2),
(28, 64, 3, '2019-07-19', 0, 9, 'bv81eqb1trvsls8fodh1f', 1, 6, 2),
(29, 49, 3, '2019-07-18', 120000, 7, '3uz4qyrk70thju4jri2oar', 1, 0, 1),
(30, 49, 3, '2019-07-18', 0, 9, 'ytqz9ifmp5kyrlhpek7h8b', 1, 6, 1),
(31, 49, 3, '2019-07-18', 0, 8, 'n0iqg5l13fyk313rocyjn', 1, 6, 0),
(32, 67, 3, '2019-07-18', 0, 8, '9mng81cerqqtxpayppcqjq', 1, 6, 0),
(33, 67, 3, '2019-07-18', 0, 13, 'xafcd74vqpvhllz139ox', 1, 6, 0);
...
INSERT INTO `nguoidung` (`idnguoidung`, `hovaten`, `idgioitinh`, `ngaysinh`, `diachi`, `sodienthoai`, `nghenghiep`, `socmnd`, `masobnxh`, `cannang`, `chieucao`, `bmi`, `idnhommau`, `tinhtrangbenhly`, `diungvacacphanung`, `cachsudungthuoc`, `email`, `matkhau`, `hinhanh`, `chucvu`, `idthanhpho`) VALUES
(49, 'Trần Ngọc Hiếu', 1, '2019-01-01', 'hutech', '0392307840', 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', '00', '00', '00', 1, 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', 'tnhieu123@gmail.com', '4297f44b13955235245b2497399d7a93', 'hieutn.jpg', 'nguoidung', 5),
(50, 'trần ngọc hiếu', 1, '2019-01-01', 'hutech', '0392307840', 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', '00', '00', '00', 1, 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', 'hieu@gmail.com', '4297f44b13955235245b2497399d7a93', 'hieutn.jpg', 'admin', 0),
(51, 'hiếu tn', 1, '2019-01-01', 'hutech', '0365955555', 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', '00', '00', '00', 1, 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', 'demo@gmail.com', '4297f44b13955235245b2497399d7a93', '', 'nguoidung', 0),
(54, 'trần ngọc hiếu', 1, '2019-01-01', '312312', '0392307840', 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', '00', '00', '00', 1, 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', 'tnhieu1231@gmail.com', '4297f44b13955235245b2497399d7a93', '', 'nguoidung', 0),
(55, 'võ thái bảo', 1, '2019-01-01', '475A đie', '0944871728', 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', '00', '00', '00', 1, 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', 'vothaibao123@gmail.com', '4297f44b13955235245b2497399d7a93', '', 'nguoidung', 0),
(56, 'võ thái bảo', 1, '2019-01-01', '475A đie', '0944871728', 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', '00', '00', '00', 1, 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', 'vothaibao1234@gmail.com', '4297f44b13955235245b2497399d7a93', '', 'nguoidung', 0),
(57, 'Đỗ Hoàng Nam', 1, '2019-01-01', 'Củ Chi', '0913113114', 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', '00', '00', '00', 1, 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', 'nhokzen25@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '', 'nguoidung', 0),
(59, 'tran ngoc hieu', 1, '2019-01-01', 'hutech', '0392307849', 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', '00', '00', '00', 1, 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', 'demohieu@gmail.com', '4297f44b13955235245b2497399d7a93', '', 'nguoidung', 0),
(62, 'trần ngọc hiếu', 1, '2019-01-01', '541 sư vạn hạnh p13 quận 10', '0392307840', 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', '00', '00', '00', 1, 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', 'tnhieu12311@gmail.com', '4297f44b13955235245b2497399d7a93', '', 'nguoidung', 0),
(64, 'trần ngọc hiếu', 1, '2019-01-01', 'hutech', '0392307845', 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', '00', '00', '00', 1, 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', 'hieutnhieu123@gmail.com', '4297f44b13955235245b2497399d7a93', '', 'nguoidung', 0),
(67, 'tran ngoc heu', 1, '2019-01-01', 'hutech', '0976777777', 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', '00', '00', '00', 1, 'chua cap nhat', 'chua cap nhat', 'chua cap nhat', 'hieuvvt123@gmail.com', '4297f44b13955235245b2497399d7a93', '', 'nguoidung', 0);
...
(1, 7, 1, 'Chào bạn, cảm ơn bạn đã gửi câu hoi cho chungs rtoo', 2, 1);
...
--
ALTER TABLE `ca`
  MODIFY `idca` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `datcauhoi`
  MODIFY `iddatcauhoi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `datlich`
--
ALTER TABLE `datlich`
  MODIFY `iddatlich` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `hdxetnghiem`
  MODIFY `idhdxetnghiem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `nguoidung`
  MODIFY `idnguoidung` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
...
--
ALTER TABLE `traloicauhoi`
  MODIFY `idtraloicauhoi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `trangthailichkham`
  MODIFY `idtrangthailichkham` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `trangthaitraloicauhoi`
--
ALTER TABLE `trangthaitraloicauhoi`
  MODIFY `idtrangthaitraloicauhoi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
