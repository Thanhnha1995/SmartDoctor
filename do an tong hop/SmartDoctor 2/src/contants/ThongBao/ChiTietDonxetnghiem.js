...
export default class ChiTietDonxetnghiem extends React.Component {
  constructor(props){
    super(props);
    this.state={
      data: [],
  ...
  fetchData = async () => {
    ...
    const response = await fetch(`${network}/thongbao/chitietdonxetnghiem.php?id=${id}`);
        ...
        renderItem={({ item }) => (
          <View style={styles.container}>
            ...
            <Text style={{
             fontSize:15,
             fontWeight:'bold' 
            }}>Mã thanh toán #{item.mahdxn}</Text>
            ...
            <View style={styles.chondanhmuc}>
              <Text style={styles.textmotavande}>Thông tin chi tiết</Text>
              <View style={styles.wrapper}>
              <View style={{
                        justifyContent:'space-between',
                        flexDirection: "row"
                      }}>
                        <Text style={styles.hovaten}>Dịch vụ</Text> 
                        <Text style={{
                          marginTop: 5,
                      ...
                      <View style={{
                        ...
                        <Text style={styles.hovaten}>Giá tiền</Text> 
                        <Text style={{
                          marginTop: 5,
                    
                        }}> {numeral(item.giatien).format("1,234")}</Text>                    
                      </View>
