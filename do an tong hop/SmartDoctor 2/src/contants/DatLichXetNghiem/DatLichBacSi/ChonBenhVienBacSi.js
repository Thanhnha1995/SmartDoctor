...
export default class ChonBenhVienBacSi extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
  ...
  fetchDataChitiet = async (item) => {
    const response = await fetch(
      `${network}/datlich/xetnghiem/ctbenhvien.php?id=${this.state.id}`
    );
    ...
    return (
      <View style={styles.container}>
        ...
        >
          ...
          />
          <TouchableOpacity
            style={{ flex: 1 / 9, backgroundColor: "#47aedf" }}
